...
/*##################################################################### */
    ...
    * SoC Debug Clock Control
    * (OFFSET, MASK, VALUE)      (0XFF18030C, 0x00000003U ,0x00000002U)
    */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0x000C03CCU ,0x00000240U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0x000C03CCU, 0x00000240U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF18020C, 0x000007FDU ,0x00000000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI2_OFFSET,
		0x000007FDU, 0x00000000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180140, 0x03FFFFFFU ,0x033FFFDEU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK0_CTRL3_OFFSET,
		0x03FFFFFFU, 0x033FFFDEU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Each bit applies to a single IO. Bit 0 for MIO[26].
    *  PSU_IOU_SLCR_BANK1_CTRL3_SCHMITT_CMOS_N_BIT_25              1

    * Selects either Schmitt or CMOS input for MIO Bank 1 - control MIO[51:26]
    * (OFFSET, MASK, VALUE)      (0XFF18015C, 0x03FFFFFFU ,0x02FF9FFFU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL3_OFFSET,
		0x03FFFFFFU, 0x02FF9FFFU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180168, 0x03FFFFFFU ,0x03FF6FFFU)
    */
	PSU_Mask_Write(IOU_SLCR_BANK1_CTRL6_OFFSET,
		0x03FFFFFFU, 0x03FF6FFFU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180178, 0x03FFFFFFU ,0x03FFEFFFU)
    */
...
/*##################################################################### */
    ...
    * SERDES ILL CALIB
    */
		serdes_illcalib(0,0,0,0,5,0,0,0);
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD410010, 0x00000070U ,0x00000050U)
    */
	PSU_Mask_Write(SERDES_ICM_CFG0_OFFSET, 0x00000070U, 0x00000050U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD615000, 0x00000F00U ,0x00000100U)
    */
	PSU_Mask_Write(FPD_SLCR_AFI_FS_OFFSET, 0x00000F00U, 0x00000100U);
/*##################################################################### */
