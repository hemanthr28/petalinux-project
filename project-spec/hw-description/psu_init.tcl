...
set psu_clock_init_data {
    ...
    mask_write 0XFF18030C 0x00000003 0x00000002
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180208 0x000C03CC 0x00000240
    ...
    mask_write 0XFF18020C 0x000007FD 0x00000000
    ...
    mask_write 0XFF180140 0x03FFFFFF 0x033FFFDE
    ...
    mask_write 0XFF18015C 0x03FFFFFF 0x02FF9FFF
    ...
    mask_write 0XFF180168 0x03FFFFFF 0x03FF6FFF
    ...
    mask_write 0XFF180178 0x03FFFFFF 0x03FFEFFF
...
set psu_serdes_init_data {
    ...
    mask_write 0XFD410010 0x00000070 0x00000050
		# : CHECKING PLL LOCK
...
set psu_afi_config {
    ...
    mask_write 0XFD615000 0x00000F00 0x00000100
